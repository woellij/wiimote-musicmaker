# SOURCE https://github.com/PetaPetaPeta/dollar-one-recognizer-python
# changes: python 3 "port"
# added method reTemplate
# added template import for "type safety"
...
class Recognizer(object):
    ...
    def addTemplate(self, template):
        self.reTemplate(template)
        self.templates.append(template)

    def reTemplate(self, template):
        template.originalPoints = template.points
